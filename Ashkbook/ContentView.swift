...
struct ContentView: View {
    ...
    let posts: [AshkbookPostModel] = [
        AshkbookPostModel(name: "Ashkan Goharfar", post: "Hello, welcome to Ashkogram, I hope you enjoy this app and its features, peace!!", imageName: "person1"),
        AshkbookPostModel(name: "Akash Raju", post: "Hello every one, nice to meet you", imageName: "person2"),
